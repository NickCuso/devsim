    ...
    if(receipt.status === 0){
      ...
      if(receipt.contract_address && receipt.contract_address.length > 0){
        ...
        var items = [
          ...
          {name: "Data Scientist", sort_id: 5, start_price: 20000000, resources_per_s: 100},
          {name: "Senior Developer", sort_id: 6, start_price: 3000000000, resources_per_s: 500},
          {name: "Architect", sort_id: 7, start_price: 2000000000000, resources_per_s: 10000},

          // Bonuses
          {name: "Marketing Manager", sort_id: 8, start_price: 500000, bonus_multiplier: 1},
          {name: "Product Manager", sort_id: 9, start_price: 35000000, bonus_multiplier: 5},
          {name: "Biz Dev", sort_id: 10, start_price: 1000000000, bonus_multiplier: 20},
        ]
